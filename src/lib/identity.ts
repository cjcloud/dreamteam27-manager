...
// Matching is case-insensitive ("cj" and "Cj" are the same manager name) —
// per CJ's explicit instruction, since managers may not type their name
